    ...
    return (
        <div className="min-h-screen bg-black">
            <div className="max-w-7xl mx-auto px-4 py-8">
                {/* Header */}
                <div className="bg-neutral-900 rounded-2xl shadow-sm border border-neutral-800 p-6 mb-8">
                    <div className="flex items-center justify-between gap-6 flex-wrap">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">@{user.username} • Joined {user.joined}</p>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Topics Distribution */}
                        <div className="bg-neutral-900 rounded-2xl shadow-sm border border-neutral-800 p-6">
                            <h2 className="text-lg font-semibold text-white mb-4">Topics Distribution</h2>
                        ...
                        <div className="bg-neutral-900 rounded-2xl shadow-sm border border-neutral-800 p-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {badges.map((b) => (
                                    <div
                                        key={b.id}
                                        className={`relative rounded-xl border p-3 ${b.earned ? 'border-neutral-800' : 'border-dashed border-neutral-800 opacity-70'}`}
                                    >
                                        ...
                                        {!b.earned && (
                                            <span className="absolute top-2 right-2 text-[10px] px-1.5 py-0.5 rounded-full bg-neutral-800 text-gray-300">Locked</span>
                                        )}
                                    </div>
                                ))}
                            </div>
...
function StatChip({ label, value }) {
    return (
        <div className="rounded-xl border border-neutral-800 bg-neutral-900 px-4 py-2 shadow-sm">
...
function DonutChart({ data, size = 160 }) {
    ...
    return (
        <div className="relative" style={{ width: size, height: size }}>
            ...
            />
            <div
                className="absolute rounded-full flex items-center justify-center bg-neutral-950"
